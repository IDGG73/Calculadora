        ...
        public override void Visit(Function function)
        {
            ...
            switch (function.Identifier.Name.ToLower())
            {
                ...
                case string n when n.Equals("acos", StringComparison.OrdinalIgnoreCase):
                    ...
                    Result = ((_options & EvaluateOptions.UseDegrees) == EvaluateOptions.UseDegrees ? new Expression($"{Math.Acos(Convert.ToDouble(Evaluate(function.Expressions[0]), _cultureInfo))}*180/{Math.PI}").Evaluate() : Math.Acos(Convert.ToDouble(Evaluate(function.Expressions[0]), _cultureInfo)));
                ...
                case string n when n.Equals("asin", StringComparison.OrdinalIgnoreCase):
                    ...
                    Result = ((_options & EvaluateOptions.UseDegrees) == EvaluateOptions.UseDegrees ? new Expression($"{Math.Asin(Convert.ToDouble(Evaluate(function.Expressions[0]), _cultureInfo))}*180/{Math.PI}").Evaluate() : Math.Asin(Convert.ToDouble(Evaluate(function.Expressions[0]), _cultureInfo)));
                ...
                case string n when n.Equals("atan", StringComparison.OrdinalIgnoreCase):
                    ...
                    Result = ((_options & EvaluateOptions.UseDegrees) == EvaluateOptions.UseDegrees ? new Expression($"{Math.Atan(Convert.ToDouble(Evaluate(function.Expressions[0]), _cultureInfo))}*180/{Math.PI}").Evaluate() : Math.Atan(Convert.ToDouble(Evaluate(function.Expressions[0]), _cultureInfo)));
                ...
                case string n when n.Equals("cos", StringComparison.OrdinalIgnoreCase):
                    ...
                    Result = Math.Cos(Convert.ToDouble(((_options & EvaluateOptions.UseDegrees) == EvaluateOptions.UseDegrees ? new Expression($"{function.Expressions[0]}*{Math.PI}/180").Evaluate() : Evaluate(function.Expressions[0])), _cultureInfo));
                ...
                case string n when n.Equals("sin", StringComparison.OrdinalIgnoreCase):
                    ...
                    Result = Math.Sin(Convert.ToDouble(((_options & EvaluateOptions.UseDegrees) == EvaluateOptions.UseDegrees ? new Expression($"{function.Expressions[0]}*{Math.PI}/180").Evaluate() : Evaluate(function.Expressions[0])), _cultureInfo));
                ...
                case string n when n.Equals("tan", StringComparison.OrdinalIgnoreCase):
                    ...
                    Result = Math.Tan(Convert.ToDouble(((_options & EvaluateOptions.UseDegrees) == EvaluateOptions.UseDegrees ? new Expression($"{function.Expressions[0]}*{Math.PI}/180").Evaluate() : Evaluate(function.Expressions[0])), _cultureInfo));
