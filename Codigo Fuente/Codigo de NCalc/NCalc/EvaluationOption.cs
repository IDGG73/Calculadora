...
namespace NCalc
{
    ...
    public enum EvaluateOptions
    {
        ...
        //
        //Summary:
        //     When using Sin(), Cos() and Tan(), this expects that the angle given by the user is in Degrees instead of Radians. If using Degrees, the angle will be converted to Radians before Evaluation.
        UseDegrees = 32
    }
}
